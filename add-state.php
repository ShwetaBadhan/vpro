...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_query($db, $query)) {
        ...
        <strong><i class='feather icon-check'></i> Thanks!</strong> State added successfully.
        ...
        <strong><i class='feather icon-check'></i> Error!</strong> Failed to add State.
        <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
          <span aria-hidden='true'>&times;</span>
        </button>
        </div>";
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Add New State</h5>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            <label for="state_name" class="form-label">State Name <span class="red-text">*</span></label>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <button type="submit" class="btn btn-secondary" name="submit">
                                            <i class="feather icon-save"></i>&nbsp; Add State
                                        </button>
                                    </div>
                                </div>
                            </form>
