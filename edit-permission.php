...
if (isset($_GET['id'])) {
    $encodedPermissionId = $_GET['id'];
   $permissionId = base64_decode($encodedPermissionId);

    // Validate$permissionId to ensure it's numeric and valid
...
if (isset($_POST['submit'])) {
    ...
    if (isset($_GET['id'])) {
        ...
        $updateQuery = "UPDATE navigation_menus 
                        SET title = '$PermissionName',  status = '$status'
                        WHERE id =$permissionId";
    } else {
    ...
    if (!empty($updateQuery)) {
        ...
        if ($updateResult) {
            ...
            echo ("<SCRIPT LANGUAGE='JavaScript'>window.location.href='manage-permission.php?status=$encodedStatus';</SCRIPT>");
        } else {
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10"><?php echo isset($_GET['id']) ? 'Update' : 'Add'; ?> Permission
                                </h5>
                            </div>
<!--                             <ul class="breadcrumb"> -->
                                ...
                                <div class=" ">
                                    ...
                                    <div class="row">
                                        <div class="col-xl- col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Permission Name<span class="red-text">*</span>
                                                <label class="sr-only control-label" for="course_name"> Permission Name<span class=" ">
                                                        </span></label>
