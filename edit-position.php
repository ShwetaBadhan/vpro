...
if (isset($_GET['id'])) {
    $encodedPositionId = $_GET['id'];
   $positionId = base64_decode($encodedPositionId);
...
if (isset($_POST['submit'])) {
    ...
    if (isset($_GET['id'])) {
        ...
        $updateQuery = "UPDATE position 
                        SET name = '$positionName',  status = '$status'
                        WHERE position_id =$positionId";
    } else {
    ...
    if (!empty($updateQuery)) {
        ...
        if ($updateResult) {
            ...
            echo ("<SCRIPT LANGUAGE='JavaScript'>window.location.href='manage-positions.php?status=$encodedStatus';</SCRIPT>");
        } else {
                                ...
                                <div class=" ">
                                    ...
                                    <div class="row">
                                        <div class="col-xl- col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="form-group"> Position Name<span class="red-text">*</span>
                                                <label class="sr-only control-label" for="course_name"> Position Name<span class=" ">
                                                        </span></label>
                                                <input id="role_name" name="name" type="text"
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <button type="submit" class="btn btn-secondary" name="submit"
                                                id="submit">
                                                <i class="feather icon-save"></i>&nbsp; <?php echo isset($_GET['id']) ? 'Update' : 'Add'; ?> 
                                            </button>
                                        </div>
                                    </div>
                                </div>
