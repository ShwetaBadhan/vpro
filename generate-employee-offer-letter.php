...
try {
    ...
    // ✅ HARDCODED: Employee letter type
    ...
    $letterheadPath = __DIR__ . '/pdf/Letterhead.pdf';
    ...
    if (!empty($row['sign']) && file_exists(__DIR__ . '/' . $row['sign'])) {
        $sigPath = __DIR__ . '/' . $row['sign'];
    }
    ...
    $unique_filename = "Employee_Offer_" . preg_replace('/[^A-Za-z0-9]/', '', $candidate_name) . "_" . time() . ".pdf";
