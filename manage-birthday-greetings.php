...
<head>
    <title>All Birthday Greetings</title>
...
<body class="">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">All Birthday Greetings
                                </h5>
                            </div>
                            <!-- 							<ul class="breadcrumb"> -->
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                           ...
                           <form id="deleteMForm" action="delete-birthday-greetings.php" method="post">
  ...
  <strong><i class='feather icon-check'></i>Success!</strong> Birthday Greetings has been Updated Successfully.
  ...
  <strong>Error!</strong> Birthday Greetings has been not Updated
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
</div> ";
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) { // Use `mysqli_fetch_assoc` for associative array
                                        ...
                                        $encoded_id = base64_encode($row['birthday_id']); // Replace with the correct ID column from your query

                                        echo "<td><input type='checkbox' name='birthday_ids[]' value='$encoded_id'></td>";
                                        ...
                                        echo "<td>
        <a href='edit-birthday-greeting.php?id=$encoded_id' class='btn btn-warning'>
            <i class='feather icon-edit'></i>
        </a>
        <a href='generate-birthday-greeting.php?id=$encoded_id' class='btn btn-success' target='_blank'>
            <i class='feather icon-users'></i>Birthday Greetings
        </a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalLabel">Delete Selected Role</h5>
                ...
                <div class="modal-body">
                    Are you sure you want to delete the birthday greeting?
    ...
    <div class="modal fade" id="alertModal" tabindex="-1" aria-labelledby="alertModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Please select at least one birthday greeting to delete.
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade" id="deleteSelectedModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to delete the selected birthday greetings?
                </div>
                <div class="modal-footer">
    ...
    <script>
        ...
        document.getElementById('confirmDelete').addEventListener('click', function() {
            ...
            if (id) {
                window.location.href = 'delete-birthday-greetings.php?id=' + encodeURIComponent(id);
            } else {
...
<script>
        document.getElementById("deleteSelected").addEventListener("click", function() {
            ...
            var checkboxes = form.querySelectorAll("input[name='birthday_ids[]']:checked");
