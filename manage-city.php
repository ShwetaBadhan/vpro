...
<body class="">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="deleteMForm" action="delete-city.php" method="post">
  ...
  <strong><i class='feather icon-check'></i>Success!</strong> City has been Updated Successfully.
  ...
  <strong>Error!</strong> City has been not Updated
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
</div> ";
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) { // Use `mysqli_fetch_assoc` for associative array
                                        ...
                                        $encoded_id = base64_encode($row['city_id']); // Replace with the correct ID column from your query

                                        echo "<td><input type='checkbox' name='city_ids[]' value='$encoded_id'></td>";

                                        echo "<td> $count </td>";
                                        echo "<td>" . htmlspecialchars($row['city_name']) . "</td>"; // Use htmlspecialchars for security
                                        ...
                                        echo "<td>
        <a href='edit-city.php?id=$encoded_id' class='btn btn-warning'>
    ...
    <script>
        document.querySelectorAll('.delete-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                const encodedId = stateId; // base64 encode
                console.log(encodedId);

                document.getElementById('deleteCityId').value = encodedId;
    ...
    <script>
        ...
        document.getElementById('confirmDelete').addEventListener('click', function() {
            ...
            if (id) {
                window.location.href = 'delete-city.php?id=' + encodeURIComponent(id);
            } else {
    ...
    <script>
        document.getElementById("deleteSelected").addEventListener("click", function() {
            ...
            var checkboxes = form.querySelectorAll("input[name='city_ids[]']:checked");
