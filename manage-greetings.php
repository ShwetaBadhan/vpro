...
LEFT JOIN position on position.position_id = eg.emp_designation;
...
<body class="">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="deleteMForm" action="delete-greetings.php" method="post">
  ...
  <strong><i class='feather icon-check'></i>Success!</strong> Greetings has been Updated Successfully.
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
</div> ";
  ...
  <strong>Error!</strong> Greetings has been not Updated
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
</div> ";
                                   ...
                                   echo "<th><input type='checkbox' id='selectAll'> SELECT</th>";
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) { // Use `mysqli_fetch_assoc` for associative array
                                        ...
                                        $encoded_id = base64_encode($row['greeting_id']); // Replace with the correct ID column from your query

                                        echo "<td><input type='checkbox' name='greeting_ids[]' value='$encoded_id' class='selectItem'></td>";
                                        ...
                                        echo "<td><img src='" . htmlspecialchars($row['emp_image']) . "' alt='Employee' style='width:100px; height:100px;'></td>";
                                        ...
                                        echo "<td>
        <a href='edit-greetings.php?id=$encoded_id' class='btn btn-warning'>
            <i class='feather icon-edit'></i>
        </a>
        <a href='generate-greetings.php?id=$encoded_id' class='btn btn-success' target='_blank'>
            <i class='feather icon-users'></i>Greetings
        </a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to delete the Greetings?
    ...
    <div class="modal fade" id="alertModal" tabindex="-1" aria-labelledby="alertModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Please select at least one greeting to delete.
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade" id="deleteSelectedModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to delete the selected greetings?
                </div>
                <div class="modal-footer">
    ...
    <script>
        ...
        document.getElementById('confirmDelete').addEventListener('click', function() {
            ...
            if (id) {
                window.location.href = 'delete-greetings.php?id=' + encodeURIComponent(id);
            } else {
    ...
    <script>
        document.getElementById("deleteSelected").addEventListener("click", function() {
            ...
            var checkboxes = form.querySelectorAll("input[name='greeting_ids[]']:checked");
