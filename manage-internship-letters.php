...
$query = "SELECT * FROM internship_certificate";
...
<head>
    <title>All Internship Letters</title>
...
<body class="">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">All Internship Letters
                                </h5>
                            </div>
                            <!-- 							<ul class="breadcrumb"> -->
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="deleteMForm" action="delete-internship-letter.php" method="post">
  ...
  <strong><i class='feather icon-check'></i>Success!</strong> Internship Letters has been Updated Successfully.
  ...
  <strong>Error!</strong> Internship Letters has been not Updated
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
</div> ";
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) { // Use `mysqli_fetch_assoc` for associative array
                                        ...
                                        $encoded_id = base64_encode($row['internship_id']); // Replace with the correct ID column from your query

                                        echo "<td><input type='checkbox' name='internship_ids[]' value='$encoded_id'></td>";
                                        ...
                                        echo "<td>
        <a href='edit-internship-letter.php?id=$encoded_id' class='btn btn-warning'>
            <i class='feather icon-edit'></i>
        </a>
        <a href='generate-internship-letter.php?id=$encoded_id' class='btn btn-success' target='_blank'>
            <i class='feather icon-users'></i>Internship Letters
        </a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to delete the internship letter?
    ...
    <div class="modal fade" id="alertModal" tabindex="-1" aria-labelledby="alertModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Please select at least one internship letters to delete.
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade" id="deleteSelectedModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to delete the selected internship letters?
                </div>
                <div class="modal-footer">
    ...
    <script>
        ...
        document.getElementById('confirmDelete').addEventListener('click', function() {
            ...
            if (id) {
                window.location.href = 'delete-internship-letter.php?id=' + encodeURIComponent(id);
            } else {
    ...
    <script>
        document.getElementById("deleteSelected").addEventListener("click", function() {
            ...
            var checkboxes = form.querySelectorAll("input[name='internship_ids[]']:checked");
