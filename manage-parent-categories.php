...
<body class="">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">All Parent Categoriess
                                </h5>
                            </div>
                            <!-- 							<ul class="breadcrumb"> -->
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="deleteMForm" action="delete-category.php" method="post">
  ...
  <strong><i class='feather icon-check'></i>Success!</strong> Parent Categories has been Updated Successfully.
  ...
  <strong>Error!</strong> Parent Categories has been not Updated
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
</div> ";
                                    ...
                                    while ($row = mysqli_fetch_row($result)) {
                                        ...
                                        echo "<td><input type='checkbox' name='cat_ids[]' value='$encoded_id'></td>";
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to delete the Parent Categories?
    ...
    <div class="modal fade" id="deleteSelectedModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to delete the selected Parent Categories?
                </div>
                <div class="modal-footer">
    ...
    <script>
        document.querySelectorAll('.delete-btn').forEach(button => {
            button.addEventListener('click', function() {
                const ParentCategoriesId = this.getAttribute('data-id');
                const encodedId = ParentCategoriesId; // base64 encode
                console.log(encodedId);

                document.getElementById('deleteParentCategoriesId').value = encodedId;
    ...
    <script>
        ...
        document.getElementById('confirmDelete').addEventListener('click', function() {
            ...
            if (id) {
                window.location.href = 'delete-category.php?id=' + encodeURIComponent(id);
            } else {
    ...
    <script>
        document.getElementById("deleteSelected").addEventListener("click", function() {
            ...
            var checkboxes = form.querySelectorAll("input[name='cat_ids[]']:checked");
