...
$query = "SELECT * FROM navigation_menus";
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">All Permissions
                                </h5>
                            </div>
<!-- 							<ul class="breadcrumb"> -->
...
<!--                             </ul> -->
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                           ...
                           <form id="deleteMForm" action="delete-permission.php" method="post">
                            ...
                            <div class="dt-responsive table-responsive mt-4">
                                ...
                                if (isset($_GET['status'])) {
                                    ...
                                    if ($st1 > 0) {
                                        echo " <div class='alert alert-success alert-dismissible fade show' Permission='alert' style='font-size:16px;' id='gold'>
  <strong><i class='feather icon-check'></i>Success!</strong> Permissionhas been Updated Successfully.
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
                                        ...
                                        echo " <div class='alert alert-danger alert-dismissible fade show' Permission='alert' style='font-size:16px;' id='gold'>
  <strong>Error!</strong> Permission has been not Updated
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
</div> ";
...
while ($row = mysqli_fetch_assoc($result)) { // Use `mysqli_fetch_assoc` for associative array
    ...
    $encoded_id = base64_encode($row['id']); // Replace with the correct ID column from your query
    
    echo "<td><input type='checkbox' name='Permission_ids[]' value='$encoded_id'></td>";
    
    echo "<td> $count </td>";
    echo "<td>" . htmlspecialchars($row['title']) . "</td>"; // Use htmlspecialchars for security
    ...
    echo "<td>
        <a href='edit-permission.php?id=$encoded_id' class='btn btn-warning'>
        ...
        <div class="modal-dialog" Permission="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalLabel">Delete Selected Permission</h5>
    ...
    <div class="modal fade" id="alertModal" tabindex="-1" aria-labelledby="alertModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Please select at least one permission to role.
                </div>
                <div class="modal-footer">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
 ...
 <script>
        ...
        document.getElementById('confirmDelete').addEventListener('click', function() {
            ...
            if (id) {
                window.location.href = 'delete-permission.php?id=' + encodeURIComponent(id);
            } else {
