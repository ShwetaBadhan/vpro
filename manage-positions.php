                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="deleteMForm" action="delete-position.php" method="post">
...
while ($row = mysqli_fetch_assoc($result)) { // Use `mysqli_fetch_assoc` for associative array
    ...
    echo "<td><input type='checkbox' name='position_ids[]' value='$encoded_id'></td>";
    
    echo "<td> $count </td>";
    echo "<td>" . htmlspecialchars($row['name']) . "</td>"; // Use htmlspecialchars for security
    ...
    echo "<td>
        <a href='edit-position.php?id=$encoded_id' class='btn btn-warning'>
...
?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalLabel">Delete Selected Position</h5>
  ...
  <!-- Alert Modal -->
    ...
    document.getElementById('confirmDelete').addEventListener('click', function() {
        ...
        if (id) {
            window.location.href = 'delete-position.php?id=' + encodeURIComponent(id);
        } else {
...
<script>
        document.getElementById("deleteSelected").addEventListener("click", function() {
            ...
            var checkboxes = form.querySelectorAll("input[name='position_ids[]']:checked");
