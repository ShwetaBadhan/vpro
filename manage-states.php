...
<body class="">
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="deleteMForm" action="delete-state.php" method="post">
  ...
  <strong><i class='feather icon-check'></i>Success!</strong> State has been Updated Successfully.
  ...
  <strong>Error!</strong> State has been not Updated
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
</div> ";
                                    ...
                                    while ($row = mysqli_fetch_row($result)) {
                                        ...
                                        echo "<td><input type='checkbox' name='state_ids[]' value='$encoded_id'></td>";
                                        ...
                                        echo "<td>
                                        <a href='edit-state.php?id=$encoded_id' class='btn btn-warning'>
    ...
    <script>
        document.querySelectorAll('.delete-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                document.getElementById('deleteStateId').value = encodedId;
    ...
    <script>
        ...
        document.getElementById('confirmDelete').addEventListener('click', function() {
            ...
            if (id) {
                window.location.href = 'delete-state.php?id=' + encodeURIComponent(id);
            } else {
    ...
    <script>
        document.getElementById("deleteSelected").addEventListener("click", function() {
            ...
            var checkboxes = form.querySelectorAll("input[name='state_ids[]']:checked");
