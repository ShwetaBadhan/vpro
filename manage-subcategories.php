                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">All Sub Categories
                                </h5>
                            </div>
                            <!-- 							<ul class="breadcrumb"> -->
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="deleteMForm" action="delete-subcategory.php" method="post">
  ...
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) { // Use `mysqli_fetch_assoc` for associative array
                                        ...
                                        $encoded_id = base64_encode($row['category_id']); // Replace with the correct ID column from your query

                                        echo "<td><input type='checkbox' name='category_ids[]' value='$encoded_id'></td>";

                                        echo "<td> $count </td>";
                                        echo "<td>" . htmlspecialchars($row['category_name']) . "</td>"; // Use htmlspecialchars for security
                                        ...
                                        echo "<td>
        <a href='edit-subcat.php?id=$encoded_id' class='btn btn-warning'>
    ...
    <script>
        ...
        document.getElementById('confirmDelete').addEventListener('click', function() {
            ...
            if (id) {
                window.location.href = 'delete-subcategory.php?id=' + encodeURIComponent(id);
            } else {
    ...
    <script>
        document.getElementById("deleteSelected").addEventListener("click", function() {
            ...
            var checkboxes = form.querySelectorAll("input[name='category_ids[]']:checked");
