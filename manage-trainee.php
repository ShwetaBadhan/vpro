...
SELECT 
    ...
    company_details.employement_type, 
    company_details.doj,
    company_details.employee_status,
    position.name AS position_name
FROM personal_details
LEFT JOIN company_details 
    ON company_details.user_id = personal_details.personal_id
LEFT JOIN position 
    ON position.position_id = company_details.designation
WHERE company_details.employement_type = 'Trainee';
